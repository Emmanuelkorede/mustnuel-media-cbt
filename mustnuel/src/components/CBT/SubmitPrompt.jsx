// =============================================================================
// src/components/CBT/SubmitPrompt.jsx
// =============================================================================
...
export default function SubmitPrompt({ 
  ...
  // Computes exam completion statistics on the fly
  const stats = useMemo(() => {
  ...
  return (
    <div className="flex flex-col gap-5 text-center select-none">
      ...
      {/* Progress status card breakdown */}
      ...
      {/* Alert block for remaining items */}
      {stats.remaining > 0 && (
        <p 
          className="text-xs text-amber-600 dark:text-amber-400 font-medium bg-amber-500/5 py-2.5 px-3 rounded-xl border border-amber-500/10"
          style={{ fontFamily: 'var(--font-body)' }}
        >
